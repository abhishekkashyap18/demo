...
function About() {
  ...
  return (
    <>
      <div >
        <div>
          <div className="lg:p-16 p-2 text-center flex flex-col items-center w-full">
            <motion.h1 
            ...
            <div className="flex flex-col lg:flex-row gap-14 lg:gap-8 p-5 text-base/6 font-normal">
              <motion.div 
              initial = {{y: 60, opacity: 0}}
              whileInView={{opacity: 1, y: 0}}
              transition = {{delay:0.5, duration: 0.9, ease: "easeInOut"}}
              ...
              className="lg:w-1/2 w-full">
                ...
                <ul>
                  <li className="flex lg:gap-1 lg:items-center items-start py-1">
                    <RiCheckboxCircleLine className="text-blue-400 w-5 h-5 lg:w-auto lg:h-auto" />
                    <p className="text-start px-1 lg:px-0">
                  ...
                  <li className="flex lg:gap-1 lg:items-center items-start py-1">
                    <RiCheckboxCircleLine className="text-blue-400 w-5 h-5 lg:w-auto lg:h-auto" />
                    <p className="text-start px-1 lg:px-0">Ullamco laboris nisi ut aliquip ex ea commodo</p>
                  </li>
                </ul>
              </motion.div>
              <motion.div 
          ...
          <div className="bg-[#f5f6f8] flex lg:flex-row flex-col-reverse gap-16 px-8 py-10 lg:px-20 lg:py-10 sm:px-10">
            <div className=" w-full lg:w-3/5">
              ...
              transition = {{delay:0.5, duration: 0.9, ease: "easeInOut"}}
              viewport={{once: true}}
              className="w-full text-[#37517e] text-2xl lg:text-4xl py-2">
              ...
              <div className="w-full flex flex-col gap-y-4">
                ...
                className="collapse collapse-arrow bg-white w-full rounded-none drop-shadow-lg">
                  ...
                  <div className="collapse-title text-base lg:text-lg font-normal text-[#47b2e4]">
          ...
          <div className="flex lg:flex-row flex-col gap-10 lg:p-16 lg:px-20 px-8 sm:p items-center">
            <motion.div 
            initial = {{scale: 0, opacity: 0}}
            whileInView={{opacity: 1, scale: 1}}
            transition = {{delay:0.5, duration: 0.9, ease: "easeInOut"}}
            viewport={{once: true}}
            className="lg:w-2/4 w-full flex flex-col items-center">
              <img className="w-[70%]" src="/skills.png" alt="" />
            </motion.div>
            <div className="lg:w-2/4 w-full py-14 lg:py-0">
              <motion.h1 
              initial = {{y: 60, opacity: 0}}
              whileInView={{opacity: 1, y: 0}}
              transition = {{delay:0.5, duration: 0.9, ease: "easeInOut"}}
              viewport={{once: true}}
              className="text-[#37517e] text-2xl lg:text-3xl font-bold pb-2">Voluptatem dignissimos provident quasi corporis voluptas</motion.h1>
              <motion.p 
              initial = {{y: 60, opacity: 0}}
              whileInView={{opacity: 1, y: 0}}
              transition = {{delay:0.5, duration: 0.9, ease: "easeInOut"}}
