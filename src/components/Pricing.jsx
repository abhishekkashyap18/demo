...
function Pricing() {
  return (
    <>
      <div className="flex flex-col items-center bg-[#f5f6f8] pt-10 h-full p-2 lg:p-3">
        <motion.h1 
        ...
        <div className="w-full px-10 lg:px-0 lg:w-fit">
          <ul className="flex lg:flex-row flex-col gap-10 sm:items-center sm:p-5">
            <motion.li 
